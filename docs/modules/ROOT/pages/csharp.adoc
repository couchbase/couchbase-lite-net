...
* Install the Couchbase Lite 2.0 framework in your project (see the link:csharp.html#_nuget[installation options]). At this point, there will be many compiler warnings. Refer to the examples on this page to learn about the new API.
