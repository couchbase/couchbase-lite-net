...
* https://github.com/couchbase/couchbase-lite-net/issues/950[*#950*] API
Enhancement Request
* https://github.com/couchbase/couchbase-lite-net/issues/951[*#951*] API
Enhancement Request - Filtered push replication
