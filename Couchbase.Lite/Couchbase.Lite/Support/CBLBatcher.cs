...
namespace Couchbase.Support
{
	...
	public class CBLBatcher<T>
	{
		...
		{
			public _Runnable_26(CBLBatcher<T> _enclosing)
			{
			...
			private readonly CBLBatcher<T> _enclosing;
		}

		private Runnable processNowRunnable;

		public CBLBatcher(ScheduledExecutorService workExecutor, int capacity, int delay, 
			CBLBatchProcessor<T> processor)
		{
