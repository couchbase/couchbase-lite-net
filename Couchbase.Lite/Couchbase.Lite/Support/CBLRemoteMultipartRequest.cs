...
{
	public class CBLRemoteMultipartRequest : CBLRemoteRequest
	{
		private MultipartEntity multiPart;

		public CBLRemoteMultipartRequest(ScheduledExecutorService workExecutor, HttpClientFactory
			 clientFactory, string method, Uri url, MultipartEntity multiPart, CBLRemoteRequestCompletionBlock
