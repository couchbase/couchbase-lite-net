...
namespace Com.Couchbase.Lite.Internal
{
	...
	public class RevisionInternal
	{
		...
		{
			bool result = false;
			if (o is Com.Couchbase.Lite.Internal.RevisionInternal)
			{
				Com.Couchbase.Lite.Internal.RevisionInternal other = (Com.Couchbase.Lite.Internal.RevisionInternal
					)o;
		...
		public virtual Com.Couchbase.Lite.Internal.RevisionInternal CopyWithDocID(string 
			docId, string revId)
		{
			...
			Com.Couchbase.Lite.Internal.RevisionInternal result = new Com.Couchbase.Lite.Internal.RevisionInternal
