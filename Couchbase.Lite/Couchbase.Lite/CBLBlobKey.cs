...
namespace Couchbase
{
	...
	public class CBLBlobKey
	{
		...
		/// eg, "sha1-LKJ32423JK..."
		/// </param>
		public CBLBlobKey(string base64Digest) : this(DecodeBase64Digest(base64Digest))
		{
		}
		...
		{
			if (!(o is Couchbase.CBLBlobKey))
			{
				return false;
			}
			Couchbase.CBLBlobKey oBlobKey = (Couchbase.CBLBlobKey)o;
		...
		{
			return Couchbase.CBLBlobKey.ConvertToHex(bytes);
		}
	}
}
