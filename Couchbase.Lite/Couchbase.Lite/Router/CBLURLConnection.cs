...
{
	public class CBLURLConnection : HttpURLConnection
	{
		...
		public CBLURLConnection(Uri url) : base(url)
		{
		...
		internal virtual void SetResponseBody(CBLBody responseBody)
		{
			this.responseBody = responseBody;
		}

		public virtual CBLBody GetResponseBody()
		{
