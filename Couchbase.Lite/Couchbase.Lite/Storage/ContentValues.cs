...
namespace Couchbase.Storage
{
	public sealed class ContentValues
	{
		...
		public ContentValues(Couchbase.Storage.ContentValues from)
		{
		...
		{
			if (!(@object is Couchbase.Storage.ContentValues))
			{
				return false;
			}
			return mValues.Equals(((Couchbase.Storage.ContentValues)@object).mValues);
		}
		...
		public void PutAll(Couchbase.Storage.ContentValues other)
		{
