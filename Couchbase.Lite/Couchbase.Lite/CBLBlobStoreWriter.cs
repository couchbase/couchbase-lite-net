...
namespace Couchbase
{
	/// <summary>Lets you stream a large attachment to a CBL_BlobStore asynchronously, e.g.
	/// 	</summary>
	/// <remarks>Lets you stream a large attachment to a CBL_BlobStore asynchronously, e.g. from a network download.
	/// 	</remarks>
