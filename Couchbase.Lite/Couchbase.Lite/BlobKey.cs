...
namespace Com.Couchbase.Lite
{
	...
	public class BlobKey
	{
		...
		{
			if (!(o is Com.Couchbase.Lite.BlobKey))
			{
				return false;
			}
			Com.Couchbase.Lite.BlobKey oBlobKey = (Com.Couchbase.Lite.BlobKey)o;
		...
		{
			return Com.Couchbase.Lite.BlobKey.ConvertToHex(bytes);
		}
