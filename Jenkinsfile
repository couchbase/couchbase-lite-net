                    ...
                    stages {
                        stage("Checkout") {
                            steps {
                                ...
                                & 'C:\\Program Files\\Git\\bin\\git.exe' clone https://github.com/couchbase/couchbase-lite-net --branch $env:BRANCH_NAME --depth 1 couchbase-lite-net
                                if($LASTEXITCODE -ne 0) {
                                    & 'C:\\Program Files\\Git\\bin\\git.exe' clone https://github.com/couchbase/couchbase-lite-net --branch $env:CHANGE_TARGET --depth 1 couchbase-lite-net
                                }
