...
namespace Couchbase.Lite.Query
{
    ...
    public static partial class IndexBuilder
    {
        ...
        [NotNull]
        public static IValueIndex ValueIndex([NotNull]params IValueIndexItem[] items) => 
            new QueryIndex(CBDebug.MustNotBeNull(WriteLog.To.Query, Tag, nameof(items), items));
        ...
        [NotNull]
        public static IFullTextIndex FullTextIndex([NotNull]params IFullTextIndexItem[] items) => 
            new QueryIndex(CBDebug.MustNotBeNull(WriteLog.To.Query, Tag, nameof(items), items));
    }
}