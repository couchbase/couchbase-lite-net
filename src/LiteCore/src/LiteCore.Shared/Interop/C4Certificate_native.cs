...
namespace LiteCore.Interop
{
    ...
    internal static unsafe partial class Native
    {
        ...
        public static partial C4Cert* c4cert_fromData([MarshalUsing(typeof(FLSliceMarshaller))] byte[]? certData, C4Error* outError);
#else
...
#if NET8_0_OR_GREATER
        [LibraryImport(Constants.DllName)]
        public static partial C4Cert* c4cert_createRequest(C4CertNameComponent* nameComponents, ulong nameCount, C4CertUsage certUsages, C4KeyPair* subjectKey, C4Error* outError);
#else
...
#if NET8_0_OR_GREATER
        [LibraryImport(Constants.DllName)]
        public static partial C4KeyPair* c4keypair_fromExternal(C4KeyPairAlgorithm algorithm, ulong keySizeInBits, void* externalKey, C4ExternalKeyCallbacks callbacks, C4Error* outError);
#else
