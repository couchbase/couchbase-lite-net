...
"C4Slice*":"FLSlice*","C4String*":"FLSlice*","int64_t":"long","C4CertNameAttributeID":"FLSlice","C4StringResult":"FLSliceResult","unsigned":"uint","size_t*":"UIntPtr*",}
bridge_types = ["UIntPtr","string","bool"]
reverse_bridge_map = {"string":"IntPtr","bool":"byte"}
skip_types = ["C4FullTextTerm","C4SocketFactory","C4ReplicatorParameters","C4PredictiveModel", "C4ExtraInfo", "C4TLSConfig", "C4ListenerConfig", "C4ExternalKeyCallbacks"]
