...
python parse_API.py -c config_fleece -v -l $PSScriptRoot\..\..\vendor\couchbase-lite-core\C\c4.exp
...
python parse_API.py -c config_c4 -v -l $PSScriptRoot\..\..\vendor\couchbase-lite-core\C\c4.exp
python parse_structs.py
Move-Item -Force *.template $PSScriptRoot\src\LiteCore.Shared\Interop
Move-Item -Force *.cs $PSScriptRoot\src\LiteCore.Shared\Interop
Remove-Item *.py
