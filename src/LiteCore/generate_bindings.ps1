...
uv venv $PSScriptRoot/.venv
. $PSScriptRoot/.venv/Scripts/Activate.ps1
uv pip install CppHeaderParser
...
try {
    ...
    python parse_API.py -c config_fleece -v -l $PSScriptRoot/binding_list/c4.def
    ...
    python parse_API.py -c config_c4 -v -l $PSScriptRoot/binding_list/c4.def
    python parse_structs.py
    Move-Item -Force *.template $PSScriptRoot/src/LiteCore.Shared/Interop
    Move-Item -Force *.cs $PSScriptRoot/src/LiteCore.Shared/Interop
    Remove-Item *.py
