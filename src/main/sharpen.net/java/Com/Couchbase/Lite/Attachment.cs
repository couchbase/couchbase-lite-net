	...
	public class Attachment
	{
		...
		public virtual InputStream GetContent()
		{
			...
			else
			{
				...
				Com.Couchbase.Lite.Attachment attachment = db.GetAttachmentForSequence(revision.GetSequence
					(), this.name);
			...
			, object> attachments, Database database)
		{
			...
			foreach (string name in attachments.Keys)
			{
				...
				if (value is Com.Couchbase.Lite.Attachment)
				{
					Com.Couchbase.Lite.Attachment attachment = (Com.Couchbase.Lite.Attachment)value;
