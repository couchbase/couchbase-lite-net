...
namespace Com.Couchbase.Lite.Storage
{
	public sealed class ContentValues
	{
		...
		public ContentValues(Com.Couchbase.Lite.Storage.ContentValues from)
		{
		...
		{
			if (!(@object is Com.Couchbase.Lite.Storage.ContentValues))
			{
				return false;
			}
			return mValues.Equals(((Com.Couchbase.Lite.Storage.ContentValues)@object).mValues
				);
		}
		...
		public void PutAll(Com.Couchbase.Lite.Storage.ContentValues other)
		{
