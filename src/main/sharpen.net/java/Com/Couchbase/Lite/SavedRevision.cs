...
namespace Com.Couchbase.Lite
{
	...
	public class SavedRevision : Revision
	{
		...
		[InterfaceAudience.Public]
		public override IList<Com.Couchbase.Lite.SavedRevision> GetRevisionHistory()
		{
			IList<Com.Couchbase.Lite.SavedRevision> revisions = new AList<Com.Couchbase.Lite.SavedRevision
				>();
			...
			foreach (RevisionInternal internalRevision in internalRevisions)
			{
				...
				{
					Com.Couchbase.Lite.SavedRevision revision = document.GetRevisionFromRev(internalRevision
						);
		...
		/// <exception cref="Com.Couchbase.Lite.CouchbaseLiteException"></exception>
		[InterfaceAudience.Public]
		public virtual Com.Couchbase.Lite.SavedRevision CreateRevision(IDictionary<string
			, object> properties)
		{
		...
		/// <exception cref="Com.Couchbase.Lite.CouchbaseLiteException"></exception>
		[InterfaceAudience.Public]
		public virtual Com.Couchbase.Lite.SavedRevision DeleteDocument()
		{
			return CreateRevision(null);
		}

		[InterfaceAudience.Public]
		public override Com.Couchbase.Lite.SavedRevision GetParentRevision()
		{
