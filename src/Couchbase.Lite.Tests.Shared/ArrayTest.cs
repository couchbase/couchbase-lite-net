...
public sealed class ArrayTest(ITestOutputHelper output) : TestCase(output)
{
    private static readonly DateTimeOffset ArrayTestDate = new(2017, 1, 1, 0, 0, 0, 0, TimeSpan.Zero);
    ...
    public void TestAddObjects()
    {
        ...
        SaveArray(array, doc, "array", a =>
        {
            ...
            subarray.ToArray().ShouldBe(["a", "b", "c"], "because that is what was added");
    ...
    public void TestAddObjectsToExistingArray()
    {
        ...
        SaveDocument(doc, d =>
        {
            ...
            a.ShouldNotBeNull("because it was saved into the document at the beginning of the test");
            ...
            subarray.ShouldNotBeNull("because an array should be present at this index");
            subarray.ToArray()
                .ShouldBe(["a", "b", "c"], "because that is what was added");
    ...
    public void TestRemoveExistingArray()
    {
        ...
        for (var i = gotArray.Count - 1; i >= 0; i--) {
            gotArray.RemoveAt(i);
        }
    ...
    public void TestTypesInArrayToJSON()
    {
        ...
        using (var savedDoc = DefaultCollection.GetDocument("doc1")) {
            savedDoc.ShouldNotBeNull("because it was just saved into the database");
            ...
            for (var i = 0; i < count; i++) {
                ...
                } else if (array[i] != null && array[i]! is float) {
    ...
    [Fact]
    public void TestMutableArrayToJsonThrowException()
    {
        var ma = new MutableArrayObject();
    ...
    [Fact]
    public void TestCreateMutableArrayWithInvalidStr()
    {
        // with random string 
