...
python $SCRIPT_DIR/../couchbase-lite-net/vendor/couchbase-lite-core/scripts/fetch_litecore.py -v $VARIANTS $DEBUG_LIB -s $Sha -o $SCRIPT_DIR/../couchbase-lite-net/vendor/couchbase-lite-core/build_cmake
